...
const About = () => {
  return (
    <div>
      ...
      <section>
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          <div className="flex flex-row items-center gap-10 md:flex-col justify-between">
          ...
          <div className="flex flex-row items-center lg:gap-10 md:flex-col justify-between">
